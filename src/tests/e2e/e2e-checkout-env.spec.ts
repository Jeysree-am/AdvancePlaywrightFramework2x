/**
 * End-to-end checkout flow (env-driven credentials):
 *   1. Log in with credentials read from the environment (USERNAME / PASSWORD).
 *   2. Navigate to the inventory page.
 *   3. Add the first item to the cart.
 *   4. Navigate to the cart page.
 *   5. From the cart, proceed through checkout step one and checkout step two.
 *   6. Enter the customer details (generated by DataGenerator) and complete the order.
 */
